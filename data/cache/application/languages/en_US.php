...
Disabled: Access to scopes will be allowed if it\'s not specified in roles.',
  ...
  'Components' => [
    ...
    'labels' => [
      'Create Components' => 'Create Komponent'
    ]
  ],
  'EquipmentClasses' => [
    'fields' => [
    ...
    'labels' => [
      'Create EquipmentClassList' => 'Create Třída vybavení'
    ]
  ],
  'EquipmentDefinitions' => [
    ...
    'labels' => [
      'Create EquipmentDefinitionList' => 'Create Definice vybavení'
    ]
  ],
  ...
  'EquipmentProperties' => [
    ...
    'labels' => [
      'Create EquipmentClassesPropertiesElements' => 'Create Vlastnost třídy vybavení'
    ],
    'options' => [
      'valueType' => [
        'String' => 'String',
  ...
  'MaterialClassList' => [
    ...
    'links' => [],
    'labels' => [
      'Create MaterialClassList' => 'Create Třída materiálu'
    ]
  ],
  'MaterialClasses' => [
    'fields' => [
    ...
    'labels' => [
      'Create MaterialClasses' => 'Create Třída materiálu'
    ]
  ],
  'MaterialDefinitionList' => [
    ...
    'links' => [],
    'labels' => [
      'Create MaterialDefinitionList' => 'Create Definice materiálu'
    ]
  ],
  'MaterialDefinitions' => [
    'fields' => [
    ...
    'labels' => [
      'Create MaterialDefinitions' => 'Create Definice materiálu'
    ]
  ],
  'MaterialDefinitionsPropertiesFromClasses' => [
    ...
    'labels' => [
      'Create MaterialDefinitionsPropertiesFromClasses' => 'Create Záznam vlastností definic materiálu'
    ]
  ],
  'MaterialLotList' => [
    'fields' => [],
  ...
  'OrderItem' => [
    ...
    'labels' => [
      'Create OrderItem' => 'Create Položka objednávky'
    ]
  ],
  'Orders' => [
    'fields' => [
    ...
    'labels' => [
      'Create Orders' => 'Create Objednávka'
    ],
    'options' => [
      'status' => [
        'new' => 'Nová',
  ...
  'PersonellClasses' => [
    ...
    'links' => [],
    'labels' => [
      'Create PersonellClasses' => 'Create Třída personálu'
    ]
  ],
  'Personnel' => [
    'fields' => [],
    'links' => [],
    'labels' => [
      'Create Personnel' => 'Create Personál'
    ]
  ],
  'PersonnelClasses' => [
    'fields' => [
    ...
    'labels' => [
      'Create PersonnelClasses' => 'Create Třída personálu'
    ]
  ],
  'PersonnelDefinitions' => [
    ...
    'labels' => [
      'Create PersonnelDefinitions' => 'Create Definice personálu'
    ]
  ],
  'PersonnelDefinitionsPropertiesFromClasses' => [
    ...
    'labels' => [
      'Create PersonnelDefinitionsPropertiesFromClasses' => 'Create Záznam vlastností definic personálu'
    ]
  ],
  'PersonnelProperties' => [
    'fields' => [
    ...
    'labels' => [
      'Create PersonnelProperties' => 'Create Vlastnost třídy personálu'
    ],
    'options' => [
      'valueType' => [
        'String' => 'String',
  ...
  'PlnovnVroby' => [
    ...
    'links' => [],
    'labels' => [
      'Create PlnovnVroby' => 'Create Plánování výroby'
    ]
  ],
  'PokusnaDruha' => [
    'fields' => [],
  ...
  'ProcessSegment' => [
    ...
    'labels' => [
      'Create ProcessSegment' => 'Create Segment procesu'
    ]
  ],
  'ProcessSegmentEquipmentItem' => [
    ...
    'labels' => [
      'Create ProcessSegmentEquipmentItem' => 'Create Položka vybavení segmentu procesu'
    ]
  ],
  'ProcessSegmentMaterialItem' => [
    ...
    'labels' => [
      'Create ProcessSegmentMaterialItem' => 'Create Položka materiálu segmentu procesu'
    ]
  ],
  'ProcessSegmentPersonnelItem' => [
    ...
    'labels' => [
      'Create ProcessSegmentPersonnelItem' => 'Create Položka personálu segmentu procesu'
    ]
  ],
  'ProductDefinitions' => [
    'fields' => [
    ...
    'labels' => [
      'Create ProductDefinitions' => 'Create Definice produktu'
    ]
  ],
  'ProductItem' => [
    'fields' => [
  ...
  'ProductSegmentEquipmentItem' => [
    ...
    'labels' => [
      'Create ProductSegmentEquipmentItem' => 'Create Položka vybavení (Segment produktu)'
    ]
  ],
  'ProductSegmentMaterialItem' => [
    ...
    'labels' => [
      'Create ProductSegmentMaterialItem' => 'Create Položka materiálu'
    ]
  ],
  'ProductSegmentPersonnelItem' => [
    ...
    'labels' => [
      'Create ProductSegmentPersonnelItem' => 'Create Položka personálu (Segment produktu)'
    ]
  ],
  'ProductSegments' => [
    'fields' => [
    ...
    'labels' => [
      'Create ProductSegments' => 'Create Segment produktu'
    ]
  ],
  'ProductionPlanning' => [
    'fields' => [
  ...
  'ProductionPlanningItem' => [
    ...
    'labels' => [
      'Create ProductionPlanningItem' => 'Create Položka plánování výroby'
    ]
  ],
  'Products' => [
    'fields' => [
    ...
    'labels' => [
      'Create Products' => 'Create Produkt'
    ],
    'options' => [
      'category' => []
    ]
  ...
  'TestovaciEntita' => [
    ...
    'links' => [],
    'labels' => [
      'Create TestovaciEntita' => 'Create TestovaciEntita'
    ]
  ],
  'TestujiDb' => [
    'fields' => [],
    'links' => [],
    'labels' => [
      'Create TestujiDb' => 'Create TestujiDb'
    ]
  ],
  'Warehouse' => [
    'fields' => [
  ...
  'WarehouseItem' => [
    ...
    'labels' => [
      'Create WarehouseItem' => 'Create Položka skladu'
    ]
  ]
];
